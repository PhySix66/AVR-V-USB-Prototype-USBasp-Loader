...
#define USBDRV_VERSION  20200708
...
#define usbDeviceConnect()      USB_PULLUP_DDR |= (1<<USB_CFG_PULLUP_BIT); USB_PULLUP_OUT |= (1<<USB_CFG_PULLUP_BIT); USBDDR &= ~(1<<USBMINUS);
#define usbDeviceDisconnect()   USB_PULLUP_DDR &= ~(1<<USB_CFG_PULLUP_BIT); USB_PULLUP_OUT &= ~(1<<USB_CFG_PULLUP_BIT); USBDDR |= (1<<USBMINUS);
