...
#ifdef	SHOW_PRAGMA
	#pragma "Setting USB_CFG_IOPORTNAME to D as Default Port"
#endif
...
#define USB_CFG_CLOCK_KHZ F_CPU/1000
	#ifdef	SHOW_PRAGMA				
		#if F_CPU	== 12000000
			#pragma	"F_CPU	== 12000000"
		#elif	F_CPU	== 16000000
			#pragma	"F_CPU	== 16000000"
		#elif	F_CPU	== 18000000
			#pragma	"F_CPU	== 18000000"
		#elif	F_CPU	== 20000000
			#pragma	"F_CPU	== 20000000"
		#else
			#pragma	"F_CPU	== FAIL"
		#endif
		#pragma	"USB_CFG_CLOCK_KHZ	== F_CPU/1000	usbcinfig.h"
	#endif
#else
	#define USB_CFG_CLOCK_KHZ 12000
	#ifdef	SHOW_PRAGMA
		#pragma	"USB_CFG_CLOCK_KHZ	usbcinfig.h"
	#endif
#endif
...
#if USB_CFG_DPLUS_BIT == USB_CFG_DMINUS_BIT
	#error	"USB_CFG_DPLUS_BIT == USB_CFG_DMINUS_BIT. D+ and D- Pins can not be the same!"
#endif

#if defined (__AVR_ATmega48P__) || (__AVR_ATmega88P__) || (__AVR_ATmega168P__) || (__AVR_ATmega328P__)
	#if USB_INTR_SEL == USB_INTR_TYPE_INTx
		#if	PORT_NUMx(USB_CFG_IOPORTNAME) == PORT_NUM_D
			#if	USB_CFG_DPLUS_BIT == 3
				...
				#ifdef	SHOW_PRAGMA
					#pragma "USB_INTR_VECTOR == INT1 Selected"
				#endif
			#elif	USB_CFG_DPLUS_BIT == 2
				#define USB_INTR_CFG            EICRA
				#define USB_INTR_CFG_SET        ((1 << ISC00) | (1 << ISC01))	//	Any Logical change
				#define USB_INTR_CFG_CLR        0
				#define USB_INTR_ENABLE         EIMSK
				#define USB_INTR_ENABLE_BIT     INT0
				#define USB_INTR_PENDING        EIFR
				...
				#define USB_INTR_VECTOR         INT0_vect
				#ifdef	SHOW_PRAGMA
					#pragma "USB_INTR_VECTOR == INT0 Selected"
				#endif
			#else
				#error	"Wrong Pin Selected. Use PD3(INT1) or PD2(INT0)."
			#endif
		#else
			#error	"Wrong PORT for USB_CFG_IOPORTNAME. Use PORTD for this Interrupt."
		#endif
	#elif USB_INTR_SEL == USB_INTR_TYPE_ICPx
		#if PORT_NUMx(USB_CFG_IOPORTNAME) == PORT_NUM_B
			#if	USB_CFG_DPLUS_BIT == 0
				#define USB_INTR_CFG            TCCR1B
				#define USB_INTR_CFG_SET        (1 << ICES1)
				#define USB_INTR_CFG_CLR        0
				...
				#ifdef	SHOW_PRAGMA
					#pragma "USB_INTR_VECTOR == TIMER1_CAPT_vect Selected"
				#endif
			#else
				#error	"USB_CFG_DPLUS_BIT Must be set to PB0 for this Interrupt."
			#endif
		#else
			#error	"USB_CFG_IOPORTNAME Must be set to PORTB for this Interrupt."
		#endif
	#else // USB_INTR_SEL == USB_INTR_TYPE_PCINTx	
		#if PORT_NUMx(USB_CFG_IOPORTNAME) == PORT_NUM_B
			...
			#ifdef	SHOW_PRAGMA
				#pragma "USB_INTR_VECTOR == PCINT0_vect Selected"
			#endif
		#elif	PORT_NUMx(USB_CFG_IOPORTNAME) == PORT_NUM_C
			...
			#ifdef	SHOW_PRAGMA
				#pragma "USB_INTR_VECTOR == PCINT1_vect Selected"
			#endif
		#elif	PORT_NUMx(USB_CFG_IOPORTNAME) == PORT_NUM_C
			...
			#ifdef	SHOW_PRAGMA
				#pragma "USB_INTR_VECTOR == PCINT2_vect Selected"
			#endif
		#endif
	#endif
#endif
